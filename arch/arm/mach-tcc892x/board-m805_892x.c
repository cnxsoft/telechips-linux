/* linux/arch/arm/mach-tcc892x/board-m805_892x.c
 *
...
#if defined(CONFIG_I2C_TCC_CORE0)
static struct tcc_i2c_platform_data m805_892x_core0_platform_data = {
...
#endif
#if defined(CONFIG_I2C_TCC_CORE1)
static struct tcc_i2c_platform_data m805_892x_core1_platform_data = {
    .core_clk_rate      = 4*1000*1000,    /* core clock rate: 4MHz */
    .core_clk_name      = "i2c1",
    .smu_i2c_flag       = 0,
...
#endif
#if defined(CONFIG_I2C_TCC_CORE2)
static struct tcc_i2c_platform_data m805_892x_core2_platform_data = {
    .core_clk_rate      = 4*1000*1000,    /* core clock rate: 4MHz */
    .core_clk_name      = "i2c2",
    .smu_i2c_flag       = 0,
    .i2c_ch_clk_rate[0] = 400,      /* SCL clock rate : 100kHz */
...
#endif
#if defined(CONFIG_I2C_TCC_CORE3)
static struct tcc_i2c_platform_data m805_892x_core3_platform_data = {
    .core_clk_rate      = 4*1000*1000,    /* core clock rate: 4MHz */
    .core_clk_name      = "i2c3",
    .smu_i2c_flag       = 0,
...
#endif
#if defined(CONFIG_I2C_TCC_SMU)
static struct tcc_i2c_platform_data m805_892x_smu_platform_data = {
    .core_clk_name  = "smu",
    .smu_i2c_flag   = 1,
};
#endif
...
static void __init m805_892x_init_irq(void)
{
	tcc_init_irq();
}
...
static int m805_892x_nand_ready(void)
{
	if ( gMultiCS == TRUE )
...
static struct tcc_nand_platform_data tcc_nand_platdata = {
	...
	.init		= m805_892x_nand_init,
	.ready		= m805_892x_nand_ready,
	.SetFlags	= m805_892x_SetFlags,
};
...
#if defined(CONFIG_I2C_TCC_CORE0)
    platform_device_add_data(&tcc8920_i2c_core0_device, &m805_892x_core0_platform_data, sizeof(struct tcc_i2c_platform_data));
#endif
#if defined(CONFIG_I2C_TCC_CORE1)
    platform_device_add_data(&tcc8920_i2c_core1_device, &m805_892x_core1_platform_data, sizeof(struct tcc_i2c_platform_data));
#endif
#if defined(CONFIG_I2C_TCC_CORE2)
    platform_device_add_data(&tcc8920_i2c_core2_device, &m805_892x_core2_platform_data, sizeof(struct tcc_i2c_platform_data));
#endif
#if defined(CONFIG_I2C_TCC_CORE3)
    platform_device_add_data(&tcc8920_i2c_core3_device, &m805_892x_core3_platform_data, sizeof(struct tcc_i2c_platform_data));
#endif
#if defined(CONFIG_I2C_TCC_SMU)
	platform_device_add_data(&tcc8920_i2c_smu_device, &m805_892x_smu_platform_data, sizeof(struct tcc_i2c_platform_data));
#endif
...
static void __init m805_892x_map_io(void)
{
	tcc_map_common_io();
}
