/*
 * arch/arm/mach-tcc88xx/tcc_clocktbl_ddr3.h
 *
...
//	{ 100000,      0, 300000,      0,  72000,      0,      0,  50000,      0,      0 },
//	{ 144000,      0, 300000,      0,  99000,      0,      0,  50000,      0,      0 },
	{ 200000,      0, 300000,      0, 108000,      0,      0,  50000,      0,      0 },	// Core 0.95V
	{ 300000,      0, 300000,      0, 112000,      0,      0,  75000,      0,      0 },
	{ 400000,      0, 300000,      0, 125000,      0,      0, 100000,      0,      0 },	// Core 1.00V
	{ 500000,      0, 300000,      0, 148000,      0,      0, 100000,      0,      0 },	// Core 1.05V
	{ 600000,      0, 300000,      0, 148000,      0,      0, 100000,      0,      0 },	// Core 1.10V
	{ 700000,      0, 300000,      0, 172000,      0,      0, 100000,      0,      0 },	// Core 1.15V
	{ 800000,      0, 320000,      0, 198000,      0,      0, 100000,      0,      0 },	// Core 1.20V
	{ 900000,      0, 360000,      0, 220000,      0,      0, 100000,      0,      0 },	// Core 1.25V
	{ 996000,      0, 400000,      0, 250000,      0,      0, 100000,      0,      0 },	// Core 1.32V
#if defined(CONFIG_CPU_HIGHSPEED)
	{1200000,      0, 400000,      0, 250000,      0,      0, 100000,      0,      0 },	// Core 1.45V
#endif
};
...
{
	{      0, 147000, 360000,      0,      0,      0,      0,      0,      0, 330000 },	// Core 1.20V
	{      0, 250000, 360000,      0,      0,      0,      0,      0,      0, 330000 },	// Core 1.20V
#if 1
	{      0, 297000, 360000,      0,      0,      0,      0,      0,      0, 330000 },	// Core 1.20V	// do not verify for Full HD
#else
	{      0, 297000, 400000,      0,      0,      0,      0,      0,      0, 330000 },	// Core 1.32V	// do not verify for Full HD
#endif
};
...
{
	{      0, 147000, 180000,      0,      0, 150000, 145000,      0,      0,      0 },	// Core 1.00V	// D1
	{      0, 221000, 250000,      0,      0, 225000, 218000,      0,      0,      0 },	// Core 1.10V	// HD
	{      0, 336000, 400000,      0,      0, 336000, 297000,      0,      0,      0 },	// Core 1.32V	// Not recommanded value
};
...
const struct tcc_freq_table_t gtVpu_480p_ClockLimitTable[] =
{
	/*  CPU /   DDI /   MEM /   GPU /    IO /  VBUS /  VCOD /   SMU /  HSIO /   CAM */
//	{      0, 147000, 180000,      0,      0, 150000, 145000,      0,      0,      0 },	// Core 1.00V	// D1
	{ 300000,      0,      0,      0, 125000,      0,      0,      0,      0,      0 },	// * 10Mbps, Core 1.00V
	{ 400000,      0,      0,      0, 148000,      0,      0,      0,      0,      0 },	//   20Mbps, Core 1.05V
	{ 500000,      0,      0,      0, 148000,      0,      0,      0,      0,      0 },	//   30Mbps, Core 1.10V
	{ 600000,      0,      0,      0, 172000,      0,      0,      0,      0,      0 },	//   40Mbps, Core 1.15V
};
...
const struct tcc_freq_table_t gtVpu_720p_ClockLimitTable[] =
{
	/*  CPU /   DDI /   MEM /   GPU /    IO /  VBUS /  VCOD /   SMU /  HSIO /   CAM */
//	{      0, 221000, 250000,      0,      0, 225000, 218000,      0,      0,      0 },	// Core 1.10V	// HD
	{ 400000,      0,      0,      0, 148000,      0,      0,      0,      0,      0 },	// * 10Mbps, Core 1.10V
	{ 500000,      0,      0,      0, 148000,      0,      0,      0,      0,      0 },	//   20Mbps, Core 1.15V
	{ 600000,      0,      0,      0, 172000,      0,      0,      0,      0,      0 },	//   30Mbps, Core 1.20V
	{ 800000,      0,      0,      0, 198000,      0,      0,      0,      0,      0 },	//   40Mbps, Core 1.25V
};
...
const struct tcc_freq_table_t gtVpu_1080p_ClockLimitTable[] =
{
	/*  CPU /   DDI /   MEM /   GPU /    IO /  VBUS /  VCOD /   SMU /  HSIO /   CAM */
//	{      0, 336000, 400000,      0,      0, 336000, 297000,      0,      0,      0 },	// Core 1.32V	// Not recommanded value
	{ 500000,      0,      0,      0, 172000,      0,      0,      0,      0,      0 },	// 	10Mbps, Core 1.30V
	{ 600000,      0,      0,      0, 198000,      0,      0,      0,      0,      0 },	// * 20Mbps, Core 1.30V
	{ 700000,      0,      0,      0, 220000,      0,      0,      0,      0,      0 }, //   30Mbps, Core 1.30V
	{ 800000,      0,      0,      0, 250000,      0,      0,      0,      0,      0 }, //   40Mbps, Core 1.30V
};
...
const struct tcc_freq_table_t gtJpegClockLimitTable[]= {
	...
	{      0, 297000, 400000,      0,      0, 336000, 297000,      0,      0,      0 },	// Core 1.32V	// Not recommanded value
};
...
const struct tcc_freq_table_t gtHdmiClockLimitTable = {
	       0, 336000, 400000,      0, 198000, 336000, 297000,      0,      0,      0	// Core 1.32V
};
...
const struct tcc_freq_table_t stFBClockLimitTable = {
	       ...
	       0, 147000, 350000,      0,  98000,      0,      0,      0,      0,      0	
#else
...
const struct tcc_freq_table_t gtBtClockLimitTable = {
	       0,      0, 400000,      0, 198000,      0,      0,      0,      0,      0	// Core 1.32V
};
...
const struct tcc_freq_table_t gtAppClockLimitTable = {
	  996000,      0, 400000,      0,      0,      0,      0,      0,      0,      0	// Core 1.32V
};
