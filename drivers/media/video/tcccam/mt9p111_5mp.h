 ...
 *
 * Register definitions for the mt9p111 CameraChip.
 *
...
#define MT9P111_REG_TERM 				0x0000	/* terminating list entry for reg */
#define MT9P111_VAL_TERM 				0x0000	/* terminating list entry for val */

#if defined(CONFIG_VIDEO_DUAL_CAMERA_SUPPORT)
extern void sensor_info_init_mt9p111(TCC_SENSOR_INFO_TYPE *sensor_info);
extern void sensor_init_fnc_mt9p111(SENSOR_FUNC_TYPE *sensor_func);
