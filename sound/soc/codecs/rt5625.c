	...
	struct snd_soc_codec *codec, unsigned int reg)
{
	...
	ret = snd_soc_write(codec, RT5625_DSP_CMD_RR,
		RT5625_DSP_R_EN | RT5625_DSP_CMD_RR);
	if (ret < 0) {
		dev_err(codec->dev, "Failed to write DSP cmd reg: %d\n", ret);
		goto err;
...
/* Voice DSP */
static const char *rt5625_aec_fun[] = {"AEC Disable","AEC Enable"};
...
static const SOC_ENUM_SINGLE_DECL(rt5640_auxout_mode_enum,
...
static const SOC_ENUM_SINGLE_DECL(rt5640_phone_mode_enum,
	RT5625_PHONEIN_VOL, RT5625_PHO_DIFF_SFT, rt5625_input_mode);

static const SOC_ENUM_SINGLE_DECL(rt5640_mic1_mode_enum,
...
static const struct snd_kcontrol_new rt5625_snd_controls[] = {
	SOC_DOUBLE_TLV("Speaker Playback Volume", RT5625_SPK_OUT_VOL,
		RT5625_L_VOL_SFT, RT5625_R_VOL_SFT, 31, 1, out_vol_tlv),
	SOC_DOUBLE("Speaker Playback Switch", RT5625_SPK_OUT_VOL,
	...
	SOC_DOUBLE("Headphone Playback Switch", RT5625_HP_OUT_VOL,
			RT5625_L_MUTE_SFT, RT5625_R_MUTE_SFT, 1, 1),
	SOC_ENUM("AUXOUT Mode Control", rt5640_auxout_mode_enum),
	...
	SOC_ENUM("Phone Mode Control", rt5640_phone_mode_enum),
	SOC_SINGLE_TLV("Phone Playback Volume", RT5625_PHONEIN_VOL,
		RT5625_L_VOL_SFT, 31, 1, in_vol_tlv),
	SOC_ENUM("MIC1 Mode Control", rt5640_mic1_mode_enum),
	...
	SOC_SINGLE_TLV("Mic1 Playback Volume", RT5625_MIC_VOL,
		RT5625_L_VOL_SFT, 31, 1, in_vol_tlv),
	SOC_ENUM("MIC2 Mode Control", rt5640_mic2_mode_enum),
	...
	SOC_ENUM("ADCL fun select Control",  adcl_fun_sel_enum),
	/* Voice DSP */
...
static const struct snd_kcontrol_new rt5625_adcl_rec_mixer[] = {
	SOC_DAPM_SINGLE("Mic1 Switch", RT5625_ADC_REC_MIXER,
				RT5625_M_RM_L_MIC1_SFT, 1, 1),
	SOC_DAPM_SINGLE("Mic2 Switch", RT5625_ADC_REC_MIXER,
				RT5625_M_RM_L_MIC2_SFT, 1, 1),
	SOC_DAPM_SINGLE("LineIn Switch", RT5625_ADC_REC_MIXER,
				RT5625_M_RM_L_LINE_SFT, 1, 1),
	SOC_DAPM_SINGLE("Phone Switch", RT5625_ADC_REC_MIXER,
				RT5625_M_RM_L_PHO_SFT, 1, 1),
	SOC_DAPM_SINGLE("HP Mixer Switch", RT5625_ADC_REC_MIXER,
				RT5625_M_RM_L_HM_SFT, 1, 1),
	SOC_DAPM_SINGLE("SPK Mixer Switch", RT5625_ADC_REC_MIXER,
				RT5625_M_RM_L_SM_SFT, 1, 1),
	SOC_DAPM_SINGLE("MoNo Mixer Switch", RT5625_ADC_REC_MIXER,
...
static const struct snd_kcontrol_new rt5625_hp_mixer[] = {
	SOC_DAPM_SINGLE("LineIn Switch", RT5625_LINE_IN_VOL,
				RT5625_M_LI_HM_SFT, 1, 1),
	SOC_DAPM_SINGLE("Phone Switch", RT5625_PHONEIN_VOL,
				RT5625_M_PHO_HM_SFT, 1, 1),
	SOC_DAPM_SINGLE("Mic1 Switch", RT5625_DAC_MIC_CTRL,
				RT5625_M_MIC1_HM_SFT, 1, 1),
	SOC_DAPM_SINGLE("Mic2 Switch", RT5625_DAC_MIC_CTRL,
				RT5625_M_MIC2_HM_SFT, 1, 1),
	SOC_DAPM_SINGLE("Voice DAC Switch", RT5625_VDAC_OUT_VOL,
				RT5625_M_VDAC_HM_SFT, 1, 1),
};

/* Left HP Mixer */
static const struct snd_kcontrol_new rt5625_hpl_mixer[] = {
	SOC_DAPM_SINGLE("ADC Switch", RT5625_ADC_REC_GAIN,
				RT5625_M_ADCL_HM_SFT, 1, 1),
	SOC_DAPM_SINGLE("DAC Switch", RT5625_DAC_MIC_CTRL,
...
static const struct snd_kcontrol_new rt5625_mono_mixer[] = {
	SOC_DAPM_SINGLE("ADCL Switch", RT5625_ADC_REC_GAIN,
				RT5625_M_ADCL_MM_SFT, 1, 1),
	SOC_DAPM_SINGLE("ADCR Switch", RT5625_ADC_REC_GAIN,
				RT5625_M_ADCR_MM_SFT, 1, 1),
	SOC_DAPM_SINGLE("Line Mixer Switch", RT5625_LINE_IN_VOL,
				RT5625_M_LI_MM_SFT, 1, 1),
	SOC_DAPM_SINGLE("Mic1 Switch", RT5625_DAC_MIC_CTRL,
				RT5625_M_MIC1_MM_SFT, 1, 1),
	SOC_DAPM_SINGLE("Mic2 Switch", RT5625_DAC_MIC_CTRL,
				RT5625_M_MIC2_MM_SFT, 1, 1),
	SOC_DAPM_SINGLE("DAC Mixer Switch", RT5625_DAC_MIC_CTRL,
...
static const struct snd_kcontrol_new adcr_fun_sel_mux =
	SOC_DAPM_ENUM("ADCR Function Select Mux", adcr_fun_sel_enum);
...
static const struct snd_kcontrol_new rxdp_pwr_sw_control =
	SOC_DAPM_SINGLE("RxDP Power Switch", RT5625_VODSP_PDM_CTL,
...
static const struct snd_kcontrol_new rxdc_pwr_sw_control =
	SOC_DAPM_SINGLE("RxDC Power Switch", RT5625_VODSP_PDM_CTL,
...
static const struct snd_soc_dapm_widget rt5625_dapm_widgets[] = {
	...
	/* Voice DSP */
	SND_SOC_DAPM_INPUT("TxDP"),
	SND_SOC_DAPM_INPUT("TxDC"),
	SND_SOC_DAPM_OUTPUT("PDM"),
	SND_SOC_DAPM_OUTPUT("RxDP"),
	SND_SOC_DAPM_MUX("ADCR fun select Mux", SND_SOC_NOPM,
				0, 0, &adcr_fun_sel_mux),
	/* SRC2 source select Mux */
	...
	SND_SOC_DAPM_SWITCH("SRC2 Enable", SND_SOC_NOPM, 0, 0,
				&src2_pwr_sw_control),
	/* PCM inf source select Mux */
	SND_SOC_DAPM_MUX("PCM src select Mux", SND_SOC_NOPM, 0, 0,
				&pcm_src_sel_mux),
	/* IIS source select Mux */
	SND_SOC_DAPM_MUX("IIS src select Mux", SND_SOC_NOPM, 0, 0,
				&rec_iis_src_mux),
	/* VoDSP */
	SND_SOC_DAPM_PGA_E("Voice DSP", SND_SOC_NOPM, 0, 0, NULL, 0,
		rt5625_vodsp_event, SND_SOC_DAPM_PRE_PMD |
		SND_SOC_DAPM_POST_PMU),
	/* VoDSP RxDP source select Mux */
	SND_SOC_DAPM_MUX("RxDP src select Mux", RT5625_VODSP_PDM_CTL,
			RT5625_RXDP_PWR_SFT, 0, &rxdp_src_sel_mux),

	/* Output */
	/* Output Stream Audio Interface */
	SND_SOC_DAPM_AIF_IN("AIF1RX", "AIF1 HiFi Playback", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("AIF2RX", "AIF2 Voice Playback", 0, SND_SOC_NOPM, 0, 0),

	/* DAC function select Mux */
	SND_SOC_DAPM_MUX("DAC fun Mux", SND_SOC_NOPM, 0, 0,
				&dac_fun_sel_mux),
	/* VDAC source select Mux */
	SND_SOC_DAPM_MUX("VDAC src Mux", SND_SOC_NOPM, 0, 0,
				&vdac_src_sel_mux),
	...
	SND_SOC_DAPM_MIXER_E("Mono HP Mixer", SND_SOC_NOPM, 0, 0,
		...
		rt5625_hpmix_event, SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
	SND_SOC_DAPM_MIXER("Left HP Mixer", RT5625_PWR_ADD2,
		RT5625_P_HM_L_BIT, 0, rt5625_hpl_mixer,
		ARRAY_SIZE(rt5625_hpl_mixer)),
	SND_SOC_DAPM_MIXER("Right HP Mixer", RT5625_PWR_ADD2,
		RT5625_P_HM_R_BIT, 0, rt5625_hpr_mixer,
		ARRAY_SIZE(rt5625_hpr_mixer)),
	...
	SND_SOC_DAPM_MUX("SPKL Vol Input Mux", RT5625_PWR_ADD3,
			RT5625_P_SPKL_VOL_BIT, 0, &spkvol_input_mux),
	SND_SOC_DAPM_MUX("SPKR Vol Input Mux", RT5625_PWR_ADD3,
			RT5625_P_SPKR_VOL_BIT, 0, &spkvol_input_mux),
...
static const struct snd_soc_dapm_route rt5625_dapm_routes[] = {
	...
	{"Left Rec Mixer", "LineIn Switch", "Left LineIn"},
	{"Left Rec Mixer", "Phone Switch", "Phone Rec Mixer"},
	{"Left Rec Mixer", "Mic1 Switch", "Mic1 Boost"},
	{"Left Rec Mixer", "Mic2 Switch", "Mic2 Boost"},
	{"Left Rec Mixer", "HP Mixer Switch", "Left HP Mixer"},
	{"Left Rec Mixer", "SPK Mixer Switch", "SPK Mixer"},
	{"Left Rec Mixer", "MoNo Mixer Switch", "Mono Mixer"},

	{"Right Rec Mixer", "LineIn Switch", "Right LineIn"},
	{"Right Rec Mixer", "Phone Switch", "Phone Rec Mixer"},
	{"Right Rec Mixer", "Mic1 Switch", "Mic1 Boost"},
	{"Right Rec Mixer", "Mic2 Switch", "Mic2 Boost"},
	{"Right Rec Mixer", "HP Mixer Switch", "Right HP Mixer"},
	{"Right Rec Mixer", "SPK Mixer Switch", "SPK Mixer"},
	{"Right Rec Mixer", "MoNo Mixer Switch", "Mono Mixer"},
	...
	{"Mic1 Volume", NULL, "Mic1"},
	{"Mic2 Volume", NULL, "Mic2"},
	...
	{"Mono HP Mixer", "LineIn Switch", "Line Mixer"},
	{"Mono HP Mixer", "Phone Switch", "Phone Volume"},
	{"Mono HP Mixer", "Mic1 Switch", "Mic1 Volume"},
	{"Mono HP Mixer", "Mic2 Switch", "Mic2 Volume"},
	{"Mono HP Mixer", "Voice DAC Switch", "Voice DAC To Mixer"},
	{"Left HP Mixer", "ADC Switch", "Left Rec Mixer"},
	{"Left HP Mixer", "DAC Switch", "Left DAC To Mixer"},
	{"Right HP Mixer", "ADC Switch", "Right Rec Mixer"},
	{"Right HP Mixer", "DAC Switch", "Right DAC To Mixer"},

	{"SPK Mixer", "Line Mixer Switch", "Line Mixer"},
	{"SPK Mixer", "Phone Switch", "Phone Volume"},
	{"SPK Mixer", "Mic1 Switch", "Mic1 Volume"},
	{"SPK Mixer", "Mic2 Switch", "Mic2 Volume"},
	{"SPK Mixer", "DAC Mixer Switch", "DAC Mixer"},
	{"SPK Mixer", "Voice DAC Switch", "Voice DAC To Mixer"},

	{"Mono Mixer", "Line Mixer Switch", "Line Mixer"},
	{"Mono Mixer", "ADCL Switch","Left Rec Mixer"},
	{"Mono Mixer", "ADCR Switch","Right Rec Mixer"},
	{"Mono Mixer", "Mic1 Switch", "Mic1 Volume"},
	{"Mono Mixer", "Mic2 Switch", "Mic2 Volume"},
	{"Mono Mixer", "DAC Mixer Switch", "DAC Mixer"},
	{"Mono Mixer", "Voice DAC Switch", "Voice DAC To Mixer"},

	{"HP Mixer", NULL, "Mono HP Mixer"},
	{"HP Mixer", NULL, "Left HP Mixer"},
	{"HP Mixer", NULL, "Right HP Mixer"},

	{"SPKL Vol Input Mux", "VMID", "VMID"},
	{"SPKL Vol Input Mux", "HP Mixer", "HP Mixer"},
	{"SPKL Vol Input Mux", "SPK Mixer", "SPK Mixer"},
	{"SPKL Vol Input Mux", "Mono Mixer", "Mono Mixer"},
	{"SPKR Vol Input Mux", "VMID", "VMID"},
	{"SPKR Vol Input Mux", "HP Mixer", "HP Mixer"},
	{"SPKR Vol Input Mux", "SPK Mixer", "SPK Mixer"},
	{"SPKR Vol Input Mux", "Mono Mixer", "Mono Mixer"},
	
	{"HPL Vol Input Mux", "HP Mixer", "Mono HP Mixer"},
	{"HPL Vol Input Mux", "HP Mixer", "Left HP Mixer"},
	{"HPL Vol Input Mux", "VMID", "VMID"},
	{"HP Amp", NULL, "HPL Vol Input Mux"},
	{"HPR Vol Input Mux", "HP Mixer", "Mono HP Mixer"},
	{"HPR Vol Input Mux", "HP Mixer", "Right HP Mixer"},
	...
	{"SPKL", NULL, "SPK Amp"},
	{"SPKL", NULL, "SPKL Vol Input Mux"},
	{"SPKR", NULL, "SPKR Vol Input Mux"},
	{"HPL", NULL, "HP Amp"},
	{"HPR", NULL, "HP Amp"},
	...
	/* Avoid dsp path to become open all the time */
	{"ADCR fun select Mux", "PDM Slave", "Right ADC"},

	{"Voice DSP", NULL, "RxDP src select Mux"},
	{"Voice DSP", NULL, "ADCR fun select Mux"},
...
static struct rt5625_init_reg init_list[] = {
	...
	{RT5625_DAC_MIC_CTRL		, 0xee03},	//DAC to hpmixer
